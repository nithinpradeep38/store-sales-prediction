...
from sales.entity.model_factory import MetricInfoArtifact, ModelFactory, GridSearchedBestModel
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            housing_model = SalesEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
