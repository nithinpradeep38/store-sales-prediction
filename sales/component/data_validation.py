...
class DataValidation:
    ...
    def does_train_test_file_exist(self)->bool:
        try:
            logging.info("Checking if training and testing file are available")
            ...
            if not is_available:
                message= f"Training and test file do not exist at {train_file_path} and {test_file_path} respectively"
    ...
    def get_and_save_data_drift_report(self):
        try:
            ...
            profile.calculate(train_df.drop(['Item_Outlet_Sales'], axis=1),test_df)
    ...
    def save_data_drift_report_page(self):
        try:
            ...
            train_df,test_df = self.get_train_and_test_df()
            dashboard.calculate(train_df.drop(['Item_Outlet_Sales'],axis=1), test_df)
